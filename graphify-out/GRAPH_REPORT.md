...
## Corpus Check
- 48 files · ~22,786 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 294 nodes · 299 edges · 38 communities (26 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `38f473e5`
...
9. `ScentScout — Claude Code Guide` - 7 edges
10. `ScentScout` - 7 edges
...
Cohesion: 0.13
Nodes (26): alertEvents, alertRules, watchlists, brands, fragrances, productVariants, alertDeliveryStatusEnum, concentrationEnum (+18 more)
...
Cohesion: 0.29
Nodes (6): Db, env, queryClient, DbEnv, dbEnvSchema, loadDbEnv()
...
## Knowledge Gaps
- **195 isolated node(s):** `$schema`, `allow`, `deny`, `PreToolUse`, `eslintConfig` (+190 more)
